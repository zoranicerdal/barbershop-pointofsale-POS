...
namespace POSales
{
    public partial class ProductModule : Form
    {
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
                if (MessageBox.Show("Da li ste sigurni da želite sačuvati ovaj proizvod?", "Sačuvaj Proizvod", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
                {
                    ...
                    cm.ExecuteNonQuery();
                    cn.Close();
                    MessageBox.Show("Proizvod je uspešno sačuvan.", stitle);
                    Clear();
                    product.LoadProduct();
                }
        ...
        private void btnUpdate_Click(object sender, EventArgs e)
        {
            try
            {
                if (MessageBox.Show("Da li ste sigurni da želite ažurirati ovaj proizvod?", "Ažuriranje Proizvoda", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
                {
                    ...
                    cm.ExecuteNonQuery();
                    cn.Close();
                    MessageBox.Show("Proizvod je uspešno ažuriran.", stitle);
                    Clear();
                    this.Dispose();
                }
