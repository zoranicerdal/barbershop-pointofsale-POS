    ...
    public partial class Settle : Form
    {
        ...
        private void btnEnter_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    MessageBox.Show("Nedovoljan iznos, unesite tačan iznos!", "Upozorenje", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                    return;
                }
                else
                {
                    ...
                    MessageBox.Show("Naplata je uspešno izvršena!", "Naplata", MessageBoxButtons.OK, MessageBoxIcon.Information);
                    cashier.GetTranNo();
                    cashier.LoadCart();
                    this.Dispose();
                }
