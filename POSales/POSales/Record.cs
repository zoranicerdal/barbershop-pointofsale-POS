...
namespace POSales
{
    public partial class Record : Form
    {
        ...
        public void LoadTopSelling()
        {
            ...
            if (cbTopSell.Text == "Sortiraj Po Količini")
            {
            ...
            else if (cbTopSell.Text == "Sortiraj Po Ukupnom Iznosu")
            {
        ...
        {
            if(cbTopSell.Text== "Izaberite tip sortiranja")
            {
                MessageBox.Show("Izaberite tip sortiranja iz padajuće liste.", "Upozorenje", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                cbTopSell.Focus();
                return;
            }
            LoadTopSelling();
        ...
        private void btnPrintSoldItems_Click(object sender, EventArgs e)
        {
            ...
            string param = "Od : " + dtFromSoldItems.Value.ToString() + " Do : " + dtToSoldItems.Value.ToString();
        ...
        {
            POSReport report = new POSReport();
            string param = "Od : " + dtFromTopSell.Value.ToString() + " Do : " + dtToTopSell.Value.ToString();
            if (cbTopSell.Text == "Sortiraj Po Količini")
            {
        ...
        {
            POSReport report = new POSReport();
            string param = "Od : " + dtFromCancel.Value.ToString() + " Do : " + dtToCancel.Value.ToString();
        ...
        {
            POSReport report = new POSReport();
            string param = "Od : " + dtFromStockIn.Value.ToString() + " Do : " + dtToStockIn.Value.ToString();
