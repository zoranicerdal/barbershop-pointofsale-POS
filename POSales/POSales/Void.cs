    ...
    public partial class Void : Form
    {
        ...
        private void btnVoid_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    MessageBox.Show("Ime osobe ili osoba koja želi poništiti je ista!. Molimo vas promenite osobu.", "Upozorenje", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                    return;
                }
                string user;
                cn.Open();
                ...
                if (dr.HasRows)
                {
                    ...
                    MessageBox.Show("Transakcija narudžbine je uspešno poništena!", "Poništi Narudžbu", MessageBoxButtons.OK, MessageBoxIcon.Information);
                    this.Dispose();
